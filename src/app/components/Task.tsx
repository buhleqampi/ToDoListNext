...
const TodoApp: FC = () => {
    ...
    return (
        <div className="max-w-lg mx-auto mt-10 p-5 bg-white shadow-md rounded-lg font-patrick-hand backdrop-blur-sm bg-opacity-80">
        <h1 className="text-2xl font-bold text-center mb-5">Todo List</h1>
        <input type="text" placeholder="Title" ref={titleInput} className="w-full p-2 mb-3 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400" />
        <input type="text" placeholder="Description" ref={descriptionInput} className="w-full p-2 mb-3 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400" />
        <input type="date" ref={dueDateInput} className="w-full p-2 mb-3 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400" />
        <div className="flex justify-between">
            <button onClick={addTask} className="flex-1 p-2 mb-3 bg-gray-500 text-white rounded hover:bg-black mr-1">Add Task</button>
            <button onClick={deleteAllTasks} className="flex-1 p-2 mb-3 bg-gray-500 text-white rounded hover:bg-black ml-1">Delete All</button>
        </div>
