...
const TodoApp: FC = () => {
    ...
    return (
        ...
        <input type="text" placeholder="Title" ref={titleInput} className="w-full p-2 mb-3 border rounded-sm focus:outline-hidden focus:ring-2 focus:ring-blue-400" />
        <input type="text" placeholder="Description" ref={descriptionInput} className="w-full p-2 mb-3 border rounded-sm focus:outline-hidden focus:ring-2 focus:ring-blue-400" />
        <input type="date" ref={dueDateInput} className="w-full p-2 mb-3 border rounded-sm focus:outline-hidden focus:ring-2 focus:ring-blue-400" />
        <div className="flex justify-between">
            <button onClick={addTask} className="flex-1 p-2 mb-3 bg-gray-500 text-white rounded-sm hover:bg-black mr-1">Add Task</button>
            <button onClick={deleteAllTasks} className="flex-1 p-2 mb-3 bg-gray-500 text-white rounded-sm hover:bg-black ml-1">Delete All</button>
        </div>
